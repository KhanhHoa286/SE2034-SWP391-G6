...
""";
     ...
     */
    public List<java.util.Map<String, Object>> getAllSystemProducts(String search, String status, int page, int pageSize) {
        List<java.util.Map<String, Object>> list = new ArrayList<>();
        String sql = "SELECT p.product_id, p.product_name, p.thumbnail_url, p.base_price, p.status, p.created_at, " +
        ...
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ...
            try (ResultSet rs = ps.executeQuery()) {
                while (rs.next()) {
                    ...
                    map.put("thumbnailUrl", rs.getString("thumbnail_url"));
    ...
    /**
     * Đếm tổng số sản phẩm hệ thống cho Admin
     */
    public int getTotalSystemProducts(String search, String status) {
    ...
    /**
     * Cập nhật trạng thái sản phẩm và ghi log (Transaction)
     */
