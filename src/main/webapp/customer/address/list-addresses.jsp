...
<div class="profile-layout address-book-layout">
    ...
    <main class="profile-main address-book-main">
        <div class="address-book-container">
            ...
            <%-- Thông báo khi customer đã đủ 6 địa chỉ --%>
            ...
            <section class="address-book-grid">
                ...
                <%-- Chỉ cho mở form thêm khi customer đang có dưới 6 địa chỉ --%>
                <c:choose>

                    <c:when test="${addressCount lt 6}">
                    ...
                    <c:otherwise>
                        <div class="address-add-card address-add-card--disabled"
                            ...
                            <span>Đã đạt tối đa 6 địa chỉ</span>
                        </div>
                    </c:otherwise>
