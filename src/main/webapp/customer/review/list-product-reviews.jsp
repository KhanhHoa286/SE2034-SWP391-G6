        ...
        <div class="col-lg-9 pl-lg-5">
            ...
            <div class="reviews-filters d-flex justify-content-between align-items-center flex-wrap gap-3 mb-5">
                <div class="filter-buttons d-flex gap-2 flex-wrap">
                    <a href="${pageContext.request.contextPath}/product-review?product_id=${productReview.productId}&page=1"
                    ...
                    <c:forEach begin="1" end="5" var="starNum">
                        ...
                        <a href="${pageContext.request.contextPath}/product-review?product_id=${productReview.productId}&page=1&star=${currentStar}"
            ...
            <c:if test="${productReview.totalPage > 1}">
                <div class="moda-pagination mt-5 mb-5">
                    <c:if test="${productReview.pageNumber > 1}">
                        <a href="${pageContext.request.contextPath}/product-review?product_id=${productReview.productId}&page=${productReview.pageNumber - 1}${not empty param.star ? '&star='.concat(param.star) : ''}" class="moda-page-link">
                            <i class="fa-solid fa-chevron-left"></i> &nbsp; TRƯỚC
                        </a>
                    </c:if>

                    <c:forEach begin="1" end="${productReview.totalPage}" var="i">
                        <a href="${pageContext.request.contextPath}/product-review?product_id=${productReview.productId}&page=${i}${not empty param.star ? '&star='.concat(param.star) : ''}"
