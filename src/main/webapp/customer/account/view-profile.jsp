...
<aside class="profile-sidebar">
    ...
    <nav class="profile-sidebar__nav">
        ...
        <a class="profile-side-link" href="${pageContext.request.contextPath}/customer/dashboard">
            <span class="material-symbols-outlined">dashboard</span>
            <span>Bảng điều khiển</span>
        </a>

        <a class="profile-side-link active" href="${pageContext.request.contextPath}/customer/profile">
            <span class="material-symbols-outlined">person</span>
            <span>Hồ sơ</span>
        </a>

        <a class="profile-side-link" href="${pageContext.request.contextPath}/customer/addresses">
            <span class="material-symbols-outlined">location_on</span>
            <span>Địa chỉ</span>
        </a>

        <a class="profile-side-link" href="${pageContext.request.contextPath}/customer/orders">
            <span class="material-symbols-outlined">shopping_cart</span>
            <span>Đơn hàng</span>
        </a>

        <a class="profile-side-link" href="${pageContext.request.contextPath}/customer/wishlist">
            <span class="material-symbols-outlined">favorite</span>
            <span>Danh sách yêu thích</span>
        </a>

        <a class="profile-side-link" href="${pageContext.request.contextPath}/seller-register">
