...
<head>
    ...
    <title>Edit Product - MODA</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/seller/seller.css?v=20260611c">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/seller/edit-product.css?v=20260611c">
...
<div class="seller-page-shell">
    ...
    <main class="seller-page-main">
        ...
        <section class="seller-page-content">
            <h1>Edit Product</h1>
            <p>Edit seller product information.</p>
        </section>
    </main>
</div>
<script>
