...
<head>
    ...
    <title>List Seller Products - MODA</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/seller/seller.css?v=20260611c">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/seller/list-seller-products.css?v=20260611c">
...
<div class="seller-page-shell">
    ...
    <main class="seller-page-main">
        ...
        <section class="seller-page-content">
            <h1>List Seller Products</h1>
            <p>Seller product list screen.</p>
        </section>
    </main>
</div>
<script>
