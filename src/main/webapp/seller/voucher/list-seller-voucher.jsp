...
<head>
    ...
    <title>List Seller Vouchers - MODA</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/seller/seller.css?v=20260611c">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/seller/list-seller-voucher.css?v=20260611c">
...
<div class="seller-page-shell">
    ...
    <main class="seller-page-main">
        ...
        <section class="seller-page-content">
            <h1>List Seller Vouchers</h1>
            <p>Seller voucher list screen.</p>
        </section>
    </main>
</div>
<script>
