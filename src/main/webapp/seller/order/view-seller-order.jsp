...
<head>
    ...
    <title>View Seller Order - MODA</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/seller/seller.css?v=20260611c">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/seller/view-seller-order.css?v=20260611c">
...
<div class="seller-page-shell">
    ...
    <main class="seller-page-main">
        ...
        <section class="seller-page-content">
            <h1>View Seller Order</h1>
            <p>Seller order detail screen.</p>
        </section>
    </main>
</div>
<script>
