...
<head>
    ...
    <title>List Seller Orders - MODA</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/seller/seller.css?v=20260611c">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/seller/list-seller-orders.css?v=20260611c">
...
<div class="seller-page-shell">
    ...
    <main class="seller-page-main">
        ...
        <section class="seller-page-content">
            <h1>List Seller Orders</h1>
            <p>Seller order list screen.</p>
        </section>
    </main>
</div>
<script>
